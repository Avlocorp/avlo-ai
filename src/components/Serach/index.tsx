...
export default function SearchInputMain({ onSendMessage }: SearchInputMainProps) {
    ...
    const AudioSize = audioFile?.size ? `${(audioFile.size / 1024 / 1024).toFixed(2)} MB` : "";
    const AudioName = audioFile?.name ? audioFile.name.replace(/.mp3|.wav|.flac|.aac|.wma/gi, "") : "";
    return (
