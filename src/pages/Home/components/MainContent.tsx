        ...
        <div className="">
            <div className="flex justify-center items-center flex-col gap-6 mb-10">
                ...
                <p className="text-[#fff] text-[40px] w-[477px]  text-center ">
                    AvloAI – Intelligent Call Center Analytics
                </p>
                <p className="text-[#71727A] text-[16px] items-center w-[554px] text-center">Transform call center data into actionable insights with the power of AI. Analyze, optimize, and enhance customer interactions like never before!</p>
            </div>
            <div >
                <p className="text-center text-[#71727A] text-[16px] mb-4">Ask about:</p>
                <div>
