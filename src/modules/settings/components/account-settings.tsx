  ...
  return (
    <div className="p-6 bg-[#2a2a2d] text-white rounded-xl">
      <div className="mb-12 pb-5 flex justify-between items-center border-b border-[#343436]">
        <div>
          <h3 className="mb-1 font-semibold text-3xl">{t("Account")}</h3>
